...
from p34_design import blinded_packets,self_audit,feature_census

STAGE="EPISTEME-P34"
MODEL_KEY="gemini"

def now_iso(): return datetime.now(timezone.utc).isoformat()
def offset(): return int(hashlib.sha256(b"P34:gemini").hexdigest()[:8],16)%10000
...
def run():
    ...
    return {
      ...
      "response_blind_feature_census":feature_census(),
      "rows":rows
    }
